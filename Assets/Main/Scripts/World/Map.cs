...
public class Map : MonoBehaviour
{
    ...
    private List<Vector2Int> m_tiles          = new List<Vector2Int>();
    ...
    public Vector2 RandomWalkable(System.Random rng)
    {
        if (m_tiles.Count > 0)
        {
            return m_tiles[rng.Next(m_tiles.Count)];
        }
        return Vector2.zero;
    }
                    ...
                    case TileType.Ground:
                        {
                            ...
                            m_tiles.Add(new Vector2Int(x, y));
                            break;
                        }
                    case TileType.Wall:
                        {
