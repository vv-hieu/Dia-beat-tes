...
public class GunWeapon : RangedWeapon
{
    ...
    private void p_SpawnProjectileAtAngle(float angle)
    {
        ...
        p.Init(GetUser(), p_BulletLifetime(), p_BulletSpeed(), dir, new string[] { "Hostile" }, p_OnProjectileHit);
    }
    ...
    private void p_OnProjectileHit(LivingEntity entity, Projectile projectile)
    {
        ...
        {
            entity.AddStatusEffect(StatusEffectManager.FrozenEffect(projectile.owner, 5.0f));
        }
